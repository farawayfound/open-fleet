...
def demo_fleet(monkeypatch, client):
    ...
    # This fleet is built around gpu-laptop-1 being the preferred, cold laptop.
    # The shipped default moved to mac-desktop-1/server-1 on 2026-09-06 (gpu-laptop-1
    # became the Athena box), so the fixture pins the preference it was
    # written for rather than inheriting whatever the default is this week.
    gw.set_public_settings({"demo_prefer_hosts": ["gpu-laptop-1"]})
